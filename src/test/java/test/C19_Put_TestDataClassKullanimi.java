...
public class C19_Put_TestDataClassKullanimi extends JsonHolderBaseUrl {
    /*
  ...
  */
    ...
    public void put01(){
        ...
        TestDataPlaceHolder testDataJsonPlaceHolder = new TestDataPlaceHolder();

        JSONObject reqBody = testDataJsonPlaceHolder.expDataOlustur();

        // 2 - Expected Data hazirla

        JSONObject expData = testDataJsonPlaceHolder.expDataOlustur();
